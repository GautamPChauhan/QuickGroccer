    ...
    <nav>
        <div class="container">
            <ul>
                ...
                <li><a href="delivery_delivered_orders.php" class="active">Delivered Orders</a></li>
            </ul>
        </div>
    </nav>
...
<?php
    ...
    WHERE o.customer_id = ca.cart_id  && o.selected_status=1 && o.status=1 && o.delivery_person_id='".$deliver_man_id."'  && sa.city='".$city."' ";
