...
<body>
    ...
    <nav>
        <div class="container">
            <ul>
                <li><a href="delivery_home.php" >Home</a></li>
                <!-- <li><a href="admin_categories.php">Categories</a></li>
                <li><a href="admin_products.php">Products</a></li> -->
                <li><a href="delivery_selected_orders.php" class="active">Selected Orders</a></li>
...
<?php
    echo "<h2> Selected Orders</h2>";

    $query = "SELECT o.customer_id,o.order_id, u.username,o.total_price ,u.phone_number, p.product_name, p.price, ca.quantity, ca.cart_id, sa.address, sa.state, sa.city 
    FROM orders o 
    ...
    WHERE o.customer_id = ca.cart_id  && o.selected_status=1 && o.status=0 && o.delivery_person_id='".$deliver_man_id."'  && sa.city='".$city."' ";
    ...
    while ($rec = mysqli_fetch_assoc($result)) {
        ...
        if (!in_array($current_id, $printed_ids)) {
            ...
            echo "<td>";
            echo "<a href='delivery_done.php?tmp_id=$tmp_id'>";
            echo "<button  class='tablebutton'>Done</button>";
            echo "</a>";
            echo "</td>";
